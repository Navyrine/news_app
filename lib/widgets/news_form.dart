...
class NewsForm extends StatefulWidget {
  const NewsForm({super.key, required this.onAddNews});
...
class _NewsFormState extends State<NewsForm> {
  ...
  void _submitForm() {
    if (_titleController.text.isEmpty || _bodyController.text.isEmpty) {
      showDialog(
          ...
          builder: (ctx) => AlertDialog(
                ...
                content: const Text(
                    "Please make sure a valid title and body news was entered!!"),
                actions: [
                  TextButton(
                      onPressed: () {
    ...
    widget.onAddNews(
        News(title: _titleController.text, body: _bodyController.text));
    Navigator.pop(context);
  }
