...
class _HomeScreenState extends State<HomeScreen> {
  final List<News> _registeredNews = [
    ...
    News(
        ...
        body:
            "JAKARTA, KOMPAS.com - Polemik mengenai kepemimpinan Yahya Cholil Staquf (Gus Yahya) sebagai Ketua Umum Pengurus Besar Nahdlatul Ulama (PBNU) semakin memanas. Sejumlah pihak berencana menggelar Muktamar Luar Biasa (MLB) PBNU dan telah membentuk struktur kepanitiaan.")
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: _openFormNews, icon: const Icon(Icons.add))
        ],
      ),
      body: Column(
        children: [
          Expanded(
            child: NewsList(
                newsList: _registeredNews, onRemoveNewsItem: _removeNews),
          ),
        ],
      ),
    );
